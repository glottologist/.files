{ pkgs, ...}:
{
  home.packages = with pkgs; [
    ...
    nodePackages.ionic                      # A tool for creating and developing Ionic Framework mobile apps.
    ...
    nodePackages.react-tools                # A set of complementary tools to React, including the JSX transformer.
    ...
    nodePackages.swagger                    # The Swagger command-line. Provides Swagger utilities and project lifecycle support.
