...
" ligo support
let g:LanguageClient_serverCommands = { 'ligo': ['~/.local/bin/Linux/bin/ligo-squirrel'], 'mligo': ['~/.local/bin/Linux/bin/ligo-squirrel'], 'religo': ['~/.local/bin/Linux/bin/ligo-squirrel'], }
