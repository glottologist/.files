...
description: >
  ...
  Covers reporting a confirmed Omnixy bug upstream — see reporting.md.
---
...
## If it is an Omnixy bug

Most application crashes are upstream bugs in those applications, not Omnixy's
doing. In the minority of cases where the cause really does sit within Omnixy's
