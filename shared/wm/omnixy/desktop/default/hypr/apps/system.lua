...
o.window(
  "(org.omnixy.btop|org.omnixy.terminal|org.omnixy.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|Omnixy|About|TUI.float|imv|mpv)",
  {
    tag = "+floating-window",
  }
)
...
-- This size only covers the first launch: omnixy-launch-about measures the
-- rendered content, remembers the size that hugs it, and applies that as its own
-- rule before every later launch.
o.window("org.omnixy.about", { float = true })
o.window("org.omnixy.about", { center = true })
o.window("org.omnixy.about", { size = { 920, 480 } })
...
o.window("org.omnixy.screensaver", { fullscreen = true })
o.window("org.omnixy.screensaver", { float = true })
o.window("org.omnixy.screensaver", { animation = "slide" })
