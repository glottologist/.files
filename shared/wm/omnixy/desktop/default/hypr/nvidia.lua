...
local nvidia = paths.omnixy_path .. "/bin/omnixy-hw-nvidia"
local nvidia_gsp = paths.omnixy_path .. "/bin/omnixy-hw-nvidia-gsp"
local nvidia_without_gsp = paths.omnixy_path .. "/bin/omnixy-hw-nvidia-without-gsp"
