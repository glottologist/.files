...
-- Used for Omnixy extension-style folders such as default/hypr/apps,
-- default/hypr/bindings, and ~/.local/state/omnixy/toggles/hypr.
-- Pass a module prefix for normal package.path modules, e.g.
--   require_all.files(paths.omnixy_path .. "/default/hypr/apps", "default.hypr.apps")
