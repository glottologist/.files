...
-- layer-shell surfaces such as Omnixy panels. A virtual keyboard (wtype) won't
...
o.bind("SUPER + CTRL + V", "Clipboard manager", "omnixy-shell shell toggle omnixy.clipboard")
