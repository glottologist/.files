...
o.bind("CTRL + ALT + DELETE", "Close all windows", "omnixy-hyprland-window-close-all")

o.bind("SUPER + J", "Toggle window split", hl.dsp.layout("togglesplit"))
o.bind("SUPER + P", "Pseudo window", hl.dsp.window.pseudo())
o.bind("SUPER + T", "Toggle window floating/tiling", hl.dsp.window.float({ action = "toggle" }))
o.bind("SUPER + F", "Full screen", hl.dsp.window.fullscreen({ mode = "fullscreen" }))
o.bind("SUPER + CTRL + F", "Tiled full screen", "omnixy-hyprland-window-tiled-fullscreen-toggle")
o.bind("SUPER + ALT + F", "Full width", hl.dsp.window.fullscreen({ mode = "maximized" }))
o.bind("SUPER + O", "Pop window out (float & pin)", "omnixy-hyprland-window-pop")
o.bind("SUPER + ALT + Home", "Save window width", "omnixy-hyprland-window-width save")
o.bind("SUPER + Home", "Restore window width", "omnixy-hyprland-window-width restore")
o.bind("SUPER + L", "Toggle workspace layout", "omnixy-hyprland-workspace-layout-toggle")
...
o.bind("SUPER + SLASH", "Monitor scaling up", "omnixy-hyprland-monitor-scaling up")
o.bind("SUPER + ALT + SLASH", "Monitor scaling down", "omnixy-hyprland-monitor-scaling down")
