...
Item {
  ...
  // Injected by omnixy-shell; defaults to the session OMNIXY_PATH.
  property string omnixyPath: Quickshell.env("OMNIXY_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("OMNIXY_IMAGE_SELECTOR_DIRS") || Quickshell.env("OMNIXY_IMAGE_SELECTOR_DIR") || Quickshell.env("OMNIXY_STOCK_BACKGROUNDS_DIR") || (stateHome + "/omnixy/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("OMNIXY_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("OMNIXY_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("OMNIXY_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return omnixyPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by omnixy-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omnixy-image-selector"
