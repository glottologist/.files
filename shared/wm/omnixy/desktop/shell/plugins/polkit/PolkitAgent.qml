...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "omnixy-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("omnixy polkit agent registered")
      else console.warn("omnixy polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omnixy-polkit"
