...
// Visual reference + live playground for omnixy-shell's common UI
// components. Summon with `omnixy dev ui-preview`, or directly via:
//   omnixy-shell shell summon omnixy.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `omnixy dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("omnixy.dev-gallery")
  ...
  FloatingWindow {
    id: window
    title: "Omnixy shell – dev gallery"
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("omnixy.dev-gallery")
    }
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `omnixy font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["omnixy.clock", "omnixy.weather", "omnixy.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "omnixy.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "omnixy-menu", label: "Omnixy menu", description: "Launcher / system menu" },
