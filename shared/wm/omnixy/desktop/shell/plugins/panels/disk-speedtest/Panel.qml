...
// omnixy-disk-speedtest run streams both phases and cleans up after itself,
...
Item {
  ...
  function dismiss() {
    if (shell && typeof shell.hide === "function")
      shell.hide((manifest && manifest.id) || "omnixy.disk-speedtest")
    else close()
  }
  ...
  SpeedTestOverlay {
    ...
    layerNamespace: "omnixy-disk-speedtest"
    title: root.diskName
    leftLabel: "READ"
    rightLabel: "WRITE"
    unit: "MB/s"
