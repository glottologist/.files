...
Panel {
  id: root
  moduleName: "omnixy.power"
  ipcTarget: "omnixy.power"
  ...
  function setProfile(profile) {
    ...
    actionProc.command = ["omnixy-powerprofiles-set", root.discharging ? "battery" : "ac", profile]
  ...
  Process {
    id: batteryProc
    command: ["omnixy-battery-status", "--shell"]
    stdout: StdioCollector { waitForEnd: true; onStreamFinished: root.updateKeyValue(text, "battery") }
  }

  Process {
    id: profilesProc
    command: ["omnixy-powerprofiles-list", "--active-state"]
    stdout: StdioCollector { waitForEnd: true; onStreamFinished: root.updateProfiles(text) }
  }

  Process {
    id: systemProc
    command: ["omnixy-system-stats"]
