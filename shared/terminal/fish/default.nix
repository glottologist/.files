...
in {
  ...
  programs.fish = {
    ...
    shellAliases = {
      ...
      dkb = "docker build -t";
      dkc = "docker-compose";
      dkcd = "docker-compose down --remove-orphans";
      dkcps = "docker-compose ps";
      dkcu = "docker-compose up";
      dki = "docker images";
      dkka = "docker kill (docker ps | awk '{print $1}' | grep -v CONTAINER)";
      dkps = "docker ps";
      dkpsa = "docker ps -a";
      dkr = "docker run ";
      dkri = "docker run -it --rm";
      dkrmi = "docker rmi --force (docker images | awk '{print $3}')";
      doa = "./do apply";
      dob = "./do build";
      doc = "cd ~/Documents";
      dock = "lazydocker";
      ...
      nfb = "nix build";
      nfbi = "nix build --impure";
      nfc = "nix flake check";
      nfca = "nix flake check --all-systems";
      nfci = "nix flake check --impure";
      nfcl = "nix flake clone";
      nfd = "nix develop";
      nfdc = "nix develop -c";
      nfdi = "nix develop --impure";
      nfe = "nix eval";
      nfei = "nix eval --impure";
      nfej = "nix eval --json";
      nfi = "nix flake init";
      nfl = "nix flake lock";
      nfli = "nix flake lock --impure";
      nfluc = "nix flake lock --update-input";
      nfm = "nix flake metadata";
      nfn = "nix flake new";
      nfp = "nix flake prefetch";
      nfr = "nix run";
      nfreg = "nix registry";
      nfrega = "nix registry add";
      nfregl = "nix registry list";
      nfregp = "nix registry pin";
      nfregr = "nix registry remove";
      nfri = "nix run --impure";
      nfs = "nix flake show";
      nfsh = "nix shell";
      nfshi = "nix shell --impure";
      nfsi = "nix flake show --impure";
      nfsl = "nix flake show --legacy";
      nfu = "nix flake update";
      nfuc = "nix flake update --commit-lock-file";
      nfui = "nix flake update --input";
      ...
      stp = "cd $HOME/.config/tmux && git reset --hard ./restore && git pull && cd -";
