{
  ...
  xdg.configFile."fish/functions/cargo_clean_repos.fish".source = ./functions/cargo_clean_repos.fish;
  xdg.configFile."fish/functions/ccp.fish".source = ./functions/ccp.fish;
  xdg.configFile."fish/functions/ccw.fish".source = ./functions/ccw.fish;
  ...
  xdg.configFile."fish/functions/gkp.fish".source = ./functions/gkp.fish;
  xdg.configFile."fish/functions/gkw.fish".source = ./functions/gkw.fish;
  ...
  xdg.configFile."fish/functions/pad_mp4.fish".source = ./functions/pad_mp4.fish;
  xdg.configFile."fish/functions/pdf_unlock.fish".source = ./functions/pdf_unlock.fish;
  xdg.configFile."fish/functions/pdf2epub.fish".source = ./functions/pdf2epub.fish;
